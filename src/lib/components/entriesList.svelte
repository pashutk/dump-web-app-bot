<script lang="ts">
	...
	export let data: readonly Entry[];
</script>

<div class="flex flex-col gap-2 m-4">
	{#each data as entry (entry.id)}
		<div class="rounded-md overflow-hidden relative">
			<div class="absolute w-1/2 bg-rose-500 h-full right-0" />
			<swiper-container
				...
				auto-height={false}
			>
				<swiper-slide><EntryItem data={entry} /></swiper-slide>
				<swiper-slide class="w-16 h-auto"
					><button
